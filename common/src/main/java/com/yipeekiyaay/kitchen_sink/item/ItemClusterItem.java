package com.yipeekiyaay.kitchen_sink.item;
...
public class ItemClusterItem extends Item {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        if (stored != null && !stored.isEmpty()) {
            ...
            tooltip.add(Text.translatable("item.kitchen_sink.cluster_item.filled", typesCount, totalCount));
        } else {
            tooltip.add(Text.translatable("item.kitchen_sink.cluster_item.empty"));
        }
        
        tooltip.add(Text.translatable("item.kitchen_sink.cluster_item.instruction.1"));
        tooltip.add(Text.translatable("item.kitchen_sink.cluster_item.instruction.2"));
